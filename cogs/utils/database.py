...
role_self_select = db['role_self_select'] # ? Collection to store the roles that can be selected by the members

warns = db['warns'] # ? Collection to store the warns of the members
